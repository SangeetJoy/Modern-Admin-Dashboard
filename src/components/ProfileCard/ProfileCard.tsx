...
const ProfileCard = ({ name, role, email, imageUrl }) => {
  return (
    <div className="relative">
      <div className="absolute z-50 bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-4 w-72 border border-gray-200 transition-all duration-200 hover:scale-105">
